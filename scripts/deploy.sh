...
build() {
  docker build -f ./docker/Dockerfile -t "192.168.1.15:5000/content-service-ui:${VERSION}" .
}

push() {
  docker push "192.168.1.15:5000/content-service-ui:${VERSION}"
}
